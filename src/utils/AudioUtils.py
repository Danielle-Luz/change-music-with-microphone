...
class AudioUtils:
  ...
  def process_audio(self):
    while self.spoken_text != 'parar':
      self.listen_audio()
      self.interpret_audio_with_language()
  ...
  def interpret_audio_with_language(self):
      try:
          self.spoken_text = self.recognizer.recognize_google(self.audio, language='pt-BR')
